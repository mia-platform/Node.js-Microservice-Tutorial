...
```json
{"name":"get-shipping-cost","status":"OK","version":"0.1.0"}
```
...
```shell
docker pull nexus.mia-platform.eu/platform-development/get-shipping-cost:latest
set -a
source .env
docker run --name get-shipping-cost \
  ...
  -p 3000:3000 \
  --detach \
  nexus.mia-platform.eu/platform-development/get-shipping-cost
```

[nvm]: https://github.com/creationix/nvm
[merge-request]: https://git.tools.mia-platform.eu/clients/mia-platform/platform-development/services/get-shipping-cost/merge_requests
